...
~~~
ab -n 100 -c 100 -p sub.json -T 'application/json' 'http://127.0.0.1:8080/Subscription/normalcall/v1/events'
ab -n 100 -c 100 -p unsub.json -T 'application/json' 'http://127.0.0.1:8080/Unsubscription/normalcall/v1/events'
ab -n 100 -c 100 'http://127.0.0.1:8080/test/test.html'
~~~

### 2. siege

~~~
siege -r 100 -c 100 -b 'http://127.0.0.1:8080/Subscription/normalcall/v1/events POST < ./sub.json'
siege -r 100 -c 100 -b 'http://127.0.0.1:8080/test/test.html'
~~~
